Algoritmo invertidor // inicio el algoritmo principal "inversor" (bien escito)
    ...
    Definir alverres Como Cadena	//definicion de variable para la cadena al verrés
    ...
    Escribir "No la lea en voz alta, porque podria ser satánico" // mi abuela en los 90 pensaba que reproducir el disco de Xuxa al revés eran mensajes satánicos
...
Funcion alverres <- inversor(catena)
	...
	alverres <- cadenaInvertida// Le colocamos un moño y se la enviamos al algoritmo principal
FinFuncion
